...
class CartAddRepository {
  /// Cart Add Api -----------------
  /// Model use Favorite Toggle caz they are same
  static Future<ApiResponse<FavoritesToggleResponse>> cartAddApi(
      int? cartId) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        var obj = favoritesToggleResponseFromJson(response.toString());
        return ApiResponse(
      ...
      if (e.type == DioExceptionType.unknown) {
        EasyLoading.dismiss();
        var obj = favoritesToggleResponseFromJson(e.response.toString());
